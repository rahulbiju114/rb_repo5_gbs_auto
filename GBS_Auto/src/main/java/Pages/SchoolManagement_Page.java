...
public class SchoolManagement_Page {
	...
	@FindBy(xpath = "//a[@href='https://gbs-plus-test.info/lms-master-test/admin-institute']")  	// Click School Management
	...
	@FindBy(xpath = "//div[@class='modal-footer']//button[@class='btn btn-primary saveBtn' and following-sibling::button[text()='Cancel']]")  	// Click save button
